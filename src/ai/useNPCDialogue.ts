...
const NOVA_DIALOGUE: DialogueBank = {
  ...
  counter_success: ['READ LIKE A BOOK!', 'I knew you\'d do that!', 'Counter city, baby!', 'TOO SLOW!', 'Telegraphed from a mile away!', 'Easy read!'],
  ...
  player_shielding: ['A shield? How BORING.', 'Can\'t catch me hiding behind barriers!', 'Shields are for people with no style.'],
  coin_rich: ['Look at all these coins — time to go CRAZY!', 'Loaded up! Watch what chaos looks like!', 'Coins for DAYS. You\'re in trouble now.'],
  dominating: ['Is this... too easy? Come on, SURPRISE me!', 'You\'re barely a warm-up.', 'I expected more chaos from you.'],
...
const SAGE_DIALOGUE: DialogueBank = {
  ...
  counter_success: ['Your patterns are transparent.', 'As I calculated.', 'The data predicted this exactly.', 'Hypothesis confirmed.', 'The model is flawless.', 'I wrote the counter before you threw the move.'],
  ...
  player_shielding: ['Shields delay the inevitable.', 'A defensive posture. Predictable.', 'Hiding confirms my threat assessment was correct.'],
  coin_rich: ['Surplus resources. Multiple high-value options now available.', 'The economy favors me. This is decisive.', 'With this capital, the outcome is mathematically certain.'],
  dominating: ['The variance is collapsing in my favor.', 'Your defeat probability now exceeds 94%.', 'The data suggests you should yield.'],
...
const IRON_DIALOGUE: DialogueBank = {
  ...
  counter_success: ['Your recklessness, punished.', 'Overextension corrected.', 'Patience rewarded.', 'The Guardian counters.', 'Aggression without discipline fails.', 'Discipline wins.'],
  ...
  player_shielding: ['A shield. Wise. But I have more patience than you.', 'We both protect. Only one of us excels at it.', 'You mirror me. Flattering. Futile.'],
  coin_rich: ['Resources secured. The offensive begins.', 'Enough coin for a decisive strike.', 'The treasury is full. The battle ends now.'],
  dominating: ['Order is restored.', 'The outcome was never in doubt.', 'Yield while you still can.'],
